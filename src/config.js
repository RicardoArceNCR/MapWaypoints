...
export const MAPS_CONFIG = {
  mapa_f1: {
    ...
    waypoints: [
      ...
      {
        mobile: { xp: 0.5, yp: 0.25, z: 0.1 },
        desktop: { xp: 0.75, yp: 0.25, z: 0.91 },
        label: "Punto Central",
        lines: [
      ...
      {
        mobile: { xp: 0.82, yp: 0.8, z: -0.02 },
        desktop: { xp: 0.75, yp: 0.75, z: 0.91 },
        label: "Momento Culminante",
        lines: [
          "Este es el punto donde todo cambia. Un momento decisivo en la narrativa.",
          "Los eventos que ocurren aquí tienen consecuencias duraderas.",
      ...
      0: [
        {
          ...
          description:
            "Roberto Danilo Samcam Ruiz regresa a Costa Rica desde México. No se observan personas o situaciones sospechosas en su permanencia en San José. Sale en taxi formal (Taxi Tap) hacia su vivienda, conducido por José Roberto Naranjo González.",
          ...
          echos: {
            person2: [
              // Echos de la Persona #2
              {
                ...
                description:
                  "Roberto Danilo Samcam Ruiz regresa a Costa Rica desde México. No se observan personas o situaciones sospechosas.",
              },
              {
                datetime: {
                  date: "15/06/2025",
                ...
                description:
                  "Segunda interacción documentada con el conductor en zona residencial.",
              },
            ],
            person1: [
              {
                ...
                description:
                  "Arribo del vuelo internacional desde Ciudad de México.",
              },
            ],
            person3: [
              {
                ...
                description:
                  "Observación del proceso de abordaje del taxi desde zona de espera.",
              },
            ],
          },
        },
        {
          ...
          description:
            "Se documenta un segundo encuentro en zona residencial. Los participantes mantienen conversación de aproximadamente 15 minutos en establecimiento comercial. No se detectan comportamientos irregulares durante la observación.",
            ...
            person4: [
              {
                ...
                description:
                  "Llegada al establecimiento comercial. Se observa actitud relajada y comportamiento normal.",
              },
              {
                datetime: {
                  date: "16/06/2025",
                ...
                description:
                  "Salida del establecimiento. Se dirige hacia vehículo estacionado en zona lateral.",
              },
            ],
            person5: [
              {
                ...
                description:
                  "Ingreso al establecimiento aproximadamente 5 minutos después del contacto principal.",
              },
              {
                datetime: {
                  date: "16/06/2025",
                ...
                description:
                  "Permanece en el lugar después de la salida del contacto principal.",
              },
            ],
            person6: [
              {
                ...
                description:
                  "Participa brevemente en la conversación. Duración aproximada: 3 minutos.",
              },
            ],
            person7: [
              {
                ...
                description:
                  "Se mantiene en las inmediaciones durante todo el evento documentado.",
              },
            ],
          },
        },

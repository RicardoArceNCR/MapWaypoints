  ...
  function getClosingBriefData() {
    return {
      ...
      methodology: {
        ...
        html: `
          <h3>Línea de Tiempo de las Pesquisas de la OIJ</h3>
          ...
          <ul>
            ...
            <li><strong>El sicario confirmado:</strong> Otro número, el 62329434, contactó a Orozco indicando que andaba con Bryan Robles. Este número fue acreditado a <strong>Luis Fernando Carvajal Fernández</strong>, el gatillero.</li>
          </ul>

          <p>El levantamiento del secreto bancario de Luis Ricardo Orozco González fue fundamental para establecer la remuneración por el crimen. Se documentó que, el mismo día del homicidio, Stephanie María Chacón Guillén realizó dos depósitos vía SINPE MÓVIL a la cuenta de Orozco por un total de ¢50.000,00, con los detalles "Viaje" y "Gasolina". Los investigadores concluyeron que este pago era la retribución por el riesgo y la colaboración en el escape de los sicarios.</p>

          <p>La convergencia de todos estos indicios (videos, testimonios, análisis telefónico, rastreo de radiobases y registros bancarios) permitió al OIJ establecer la participación activa de Chaves Medina, Robles Salas, Carvajal Fernández y Orozco González en la planificación, ejecución y soporte logístico del asesinato.</p>

          <h4>Los allanamientos</h4>

          <p>Aunque el informe del OIJ con fecha 28 de agosto de 2025 había solicitado las órdenes de allanamiento para el 10 de septiembre, la acción operativa se concretó los días 11 y 12 de septiembre de 2025. Agentes del OIJ, junto con su director Randall Zúñiga y el fiscal general Carlo Díaz, ejecutaron operativos en León XIII (Cantón de Tibás, San José) y en Cañas, Guanacaste. Estas diligencias resultaron en la captura de cuatro de los cinco sospechosos.</p>

          <ul>
            <li><strong>Danilo José Chaves Medina</strong> (35 años) — intermediario clave entre los autores intelectuales y materiales. Detenido en Cañas, Guanacaste. Tenía en su poder ¢4.000.000 en efectivo.</li>
            <li><strong>Bryan Steven Robles Salas</strong> (23 años) — presunto conductor del Renault Duster durante la ejecución y la huida. Detenido en León XIII.</li>
            <li><strong>Luis Ricardo Orozco González</strong> (33 años) — taxista informal que condujo el Hyundai celeste de rescate. Su teléfono y registros bancarios fueron pieza clave.</li>
            <li><strong>Stephanie María Chacón Guillén</strong> (30 años) — pareja de Chaves Medina, presuntamente realizó los depósitos de pago. Enfrentará el proceso en libertad.</li>
          </ul>

          <p>Tras las detenciones, Chaves Medina, Robles Salas y Orozco González fueron puestos en prisión preventiva por seis meses. El gatillero, <strong>Luis Fernando Carvajal Fernández</strong> (20 años), seguía prófugo y fue capturado posteriormente el 10 de febrero de 2026 por la Policía Municipal de San Isidro de Heredia.</p>

          <h4>El autor intelectual</h4>

          <p>La investigación señaló como presunto "cerebro" del homicidio a <strong>Pablo Antonio Robles Murillo</strong>, sujeto nicaragüense naturalizado costarricense con vínculos con la plana mayor del Ejército de Nicaragua. Información confidencial sugirió que estuvo en Rusia entrenando en labores de inteligencia, asesinato y sabotaje.</p>

          <p>Robles Murillo salió del país hacia Nicaragua el 10 de mayo de 2025 (antes del crimen), regresó el 23 de julio, y su último viaje documentado fue el 7 de agosto de 2025. Desde entonces no ha retornado por un puesto fronterizo oficial. Por el momento, no está formalmente imputado en el caso.</p>

          <p>El Fiscal General Carlo Díaz sostuvo que la principal línea de investigación apunta a que el crimen fue <em>"una orden aparentemente del Ejército nicaragüense"</em>. La investigación se mantiene abierta para identificar a los autores intelectuales.</p>
        `
      }
    };
  }
